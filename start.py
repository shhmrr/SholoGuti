...
from shologuti import SholoGuti
...
def play_shologuti(mode):
    ...
    if mode == 'train':
        ...
        rax_reward1.set(ylabel='Cumulative Reward', title='Shologuti Cumulative Reward Episodes')
        ...
        rfig.savefig('shologuti_reward.png')
        ...
        memax_reward1.set(ylabel='Size (KB)', title='Shologuti QTable Size Episodes')
        ...
        memfig.savefig('shologuti_memory.png')
        plt.show()

        agent.save_values(path='shologuti_qtable.json')
        agent.stats()
        agent.demo()

    elif mode == 'demo':
        qtable = json.load(open('shologuti_qtable.json'))
...
def main():
    ...
    if options.game == 'shologuti':
        play_shologuti(options.mode)
